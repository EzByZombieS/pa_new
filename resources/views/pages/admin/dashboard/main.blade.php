        ...
        <div class="col-sm-6 col-xl-3 mb-xl-10">
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <!--end::Svg Icon-->{{number_format($increase_product,2,',')}}%</span>
                    <!--end::Badge-->
                </div>
                <!--end::Body-->
            </div>
        ...
        <div class="col-sm-6 col-xl-3 mb-xl-10">
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <!--end::Svg Icon-->{{number_format($increase_order,2,',')}}%</span>
                    <!--end::Badge-->
                </div>
                <!--end::Body-->
            </div>
        ...
        <div class="col-sm-6 col-xl-3 mb-xl-10">
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <!--end::Svg Icon-->{{number_format($increase_critic,2,',')}}%</span>
                    <!--end::Badge-->
                </div>
                <!--end::Body-->
            </div>
        ...
        <div class="col-sm-6 col-xl-3 mb-xl-10">
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <!--end::Svg Icon-->{{number_format($increase_user,2,',')}}%</span>
                    <!--end::Badge-->
                </div>
                <!--end::Body-->
            </div>
